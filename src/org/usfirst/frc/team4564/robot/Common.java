...
public class Common {
	...
	//New for OCTalon
	/**Gets an double from Smart Dashboard
	 * 
	 * @param title -Title of value to get
	 * @return -value from smart dashboard 999 is an default value
	 */
	public static double getNum(String title) {
		return SmartDashboard.getNumber(title, 999);
	}
